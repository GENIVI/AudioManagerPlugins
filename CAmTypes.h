...
struct gc_Source_s : public am_Source_s
{
    ...
    int32_t priority;
    std::map<int16_t, float > mapUserVolumeToNormalizedVolume; // not required
    std::map<float, float > mapNormalizedVolumeToDecibelVolume; // not required
